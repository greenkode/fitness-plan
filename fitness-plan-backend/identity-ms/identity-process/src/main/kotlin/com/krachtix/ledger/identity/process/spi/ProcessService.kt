package com.krachtix.identity.process.spi
...
import com.krachtix.identity.process.domain.ProcessEntity
import com.krachtix.identity.process.domain.ProcessRepository
import com.krachtix.identity.process.domain.ProcessRequestEntity
import com.krachtix.identity.process.domain.model.ProcessCreatedEvent
import com.krachtix.identity.process.orchestrator.ProcessOrchestrator
...
class ProcessService(
    ...
    override fun makeRequest(payload: MakeProcessRequestPayload) {
        ...
        val process = processRepository.findByPublicId(payload.publicId)
