package com.krachtix.identity.core.invitation.dto
...
@Schema(description = "Revoke invitation request")
data class RevokeInvitationRequest(
    @Schema(description = "User ID to revoke invitation for", example = "user_123", required = true)
    val userId: String
)

@Schema(description = "Revoke invitation response")
data class RevokeInvitationResponse(
    @Schema(description = "Whether revocation was successful", example = "true")
    val success: Boolean,
    @Schema(description = "Response message", example = "Invitation revoked successfully")
    val message: String
)