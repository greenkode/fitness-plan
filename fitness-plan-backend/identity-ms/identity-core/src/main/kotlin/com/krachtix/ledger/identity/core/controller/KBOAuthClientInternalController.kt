...
import com.krachtix.commons.internal.CreateKBOAuthClientRequest
import com.krachtix.commons.internal.CreateKBOAuthClientResponse
import com.krachtix.commons.internal.RevokeKBOAuthClientResponse
import com.krachtix.commons.internal.RotateSecretResponse
...
class KBOAuthClientInternalController(
    ...
    fun createKBOAuthClient(@RequestBody request: CreateKBOAuthClientRequest): CreateKBOAuthClientResponse {
        ...
        val client = OAuthRegisteredClient().apply {
            ...
            this.sandboxClientSecret = encodedSecret
            this.productionClientSecret = encodedSecret
    ...
    fun rotateKBOAuthClientSecret(@PathVariable knowledgeBaseId: String): RotateSecretResponse {
        ...
        val encodedSecret = passwordEncoder.encode(newSecret)
