package com.krachtix.identity.core.password.controller

import com.krachtix.identity.core.integration.CompletePasswordResetRequest
import com.krachtix.identity.core.integration.InitiatePasswordResetRequest
import com.krachtix.identity.core.integration.ValidatePasswordResetRequest
import com.krachtix.identity.core.integration.ValidatePasswordResetResponse
import com.krachtix.identity.core.password.command.CompletePasswordResetCommand
import com.krachtix.identity.core.password.command.CompletePasswordResetResult
import com.krachtix.identity.core.password.command.InitiatePasswordResetCommand
import com.krachtix.identity.core.password.command.InitiatePasswordResetResult
import com.krachtix.identity.core.password.command.ValidatePasswordResetCommand
    ...
    fun completePasswordReset(
        ...
        return pipeline.send(
            CompletePasswordResetCommand(
                ...
                token = request.token,
                newPassword = request.newPassword.copyOf()
            )
        )
    }
}