package com.krachtix.identity.core.profile.controller

import com.krachtix.commons.dto.PhoneNumber
import com.krachtix.identity.core.profile.command.ChangePasswordCommand
import com.krachtix.identity.core.profile.command.GenerateAvatarCommand
import com.krachtix.identity.core.profile.command.UpdateProfileCommand
import com.krachtix.identity.core.profile.command.UploadAvatarCommand
import com.krachtix.identity.core.profile.dto.ChangePasswordRequest
import com.krachtix.identity.core.profile.dto.ChangePasswordResponse
import com.krachtix.identity.core.profile.dto.GenerateAvatarRequest
import com.krachtix.identity.core.profile.dto.GenerateAvatarResponse
import com.krachtix.identity.core.profile.dto.UpdateProfileRequest
import com.krachtix.identity.core.profile.dto.UpdateProfileResponse
import com.krachtix.identity.core.profile.dto.UploadAvatarResponse
import com.krachtix.identity.core.profile.dto.UserProfileResponse
import com.krachtix.identity.core.profile.query.GetUserProfileQuery
...
class ProfileController(
    ...
    fun updateProfile(@RequestBody request: UpdateProfileRequest): UpdateProfileResponse {
        ...
        val phoneNumber = request.phoneNumber?.takeIf { it.isNotBlank() }?.let { number ->
            request.countryCode?.takeIf { it.isNotBlank() }?.let { code ->
                ...
                PhoneNumber.fromRawNumber(number, locale)
            }
        }
    ...
    @RateLimiting(name = "password-change")
    ...
    @ApiResponses(
        value = [
            ...
            ApiResponse(responseCode = "400", description = "Invalid current password or same as current")
        ]
    )
    @SecurityRequirement(name = "bearerAuth")
