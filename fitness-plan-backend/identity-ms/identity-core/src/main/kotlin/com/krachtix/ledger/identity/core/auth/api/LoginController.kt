...
import com.krachtix.identity.commons.dto.UserSummary
import com.krachtix.identity.core.auth.command.LoginCommand
import com.krachtix.identity.core.auth.command.LoginResult
    ...
    fun apiLogin(@RequestBody loginRequest: LoginRequest): TokenResponse {
        ...
        return pipeline.send(
            LoginCommand(
                ...
                password = loginRequest.password.copyOf(),
