package com.krachtix.identity.core.profile.dto
...
data class UserProfileResponse(
    ...
    @Schema(description = "Registration source (SELF_REGISTRATION, INVITATION, OAUTH_GOOGLE, OAUTH_MICROSOFT)")
...
data class ChangePasswordResponse(
    @Schema(description = "Whether the password change was successful")
    val success: Boolean,
