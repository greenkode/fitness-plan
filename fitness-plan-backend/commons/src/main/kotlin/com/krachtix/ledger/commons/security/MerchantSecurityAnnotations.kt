...
@Target(AnnotationTarget.FUNCTION, AnnotationTarget.CLASS)
@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("hasAnyRole('MERCHANT_SUPER_ADMIN', 'MERCHANT_ADMIN', 'MERCHANT_FINANCE_ADMIN')")
annotation class IsMerchantFinanceAdmin

@Target(AnnotationTarget.FUNCTION, AnnotationTarget.CLASS)
@Retention(AnnotationRetention.RUNTIME)
@PreAuthorize("hasAnyRole('MERCHANT_SUPER_ADMIN', 'MERCHANT_ADMIN', 'MERCHANT_FINANCE_ADMIN', 'MERCHANT_USER')")
