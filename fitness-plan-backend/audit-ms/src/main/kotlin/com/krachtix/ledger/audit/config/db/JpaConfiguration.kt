package com.krachtix.audit.config.db
...
class JpaConfiguration {
    ...
    fun readReplicaEntityManagerFactory(
        ...
        return builder
            .dataSource(dataSource)
            .packages("com.krachtix.audit.domain")
...
@EnableJpaRepositories(
    basePackages = ["com.krachtix.audit"],
...
@Configuration
@EnableJpaRepositories(
    basePackages = ["com.krachtix.audit.domain.query"],
